...
func (_m *MockgrpcServer) RegisterService(sd *grpc.ServiceDesc, ss any) {
	_m.Called(sd, ss)
}
...
func (_c *MockgrpcServer_RegisterService_Call) Run(run func(sd *grpc.ServiceDesc, ss any)) *MockgrpcServer_RegisterService_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockgrpcServer_RegisterService_Call) RunAndReturn(run func(*grpc.ServiceDesc, any)) *MockgrpcServer_RegisterService_Call {
	_c.Call.Return(run)
	return _c
}
